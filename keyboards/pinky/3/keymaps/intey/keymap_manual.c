...
enum INTEY_MACRO_KEYS {
  HMMACRO = SAFE_RANGE,
};

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x7_4(
      DV_GRV,    DV_QUOT,  DV_COMM, DV_DOT,   DV_P,     DV_Y,     DV_LPRN,   /*  */ DV_RPRN, DV_F,     DV_G,     DV_C,     DV_R,     DV_L,     DV_EQL,
RCTL_T(KC_TAB),  DV_A,     DV_O,    DV_E,     DV_U,     DV_I,     DV_LBRC,   /*  */ DV_RBRC, DV_D,     DV_H,     DV_T,     DV_N,     DV_S,     DV_MINS,
      DV_BSLS,   DV_SCLN,  DV_Q,    DV_J,     DV_K,     DV_X,     KC_ESC,    /*  */ KC_ENT,  DV_B,     DV_M,     DV_W,     DV_V,     DV_Z,     KC_BSPC,
                                    TT(1),    MO(2),    KC_LALT,  LCTL_T(KC_SPC),  KC_SPC,LSFT_T(DV_SLSH),  KC_LGUI,  KC_DEL),
    ...
    [2] = LAYOUT_split_3x7_4(
      _______,  DV_LBRC,  KC_1,     KC_2,     KC_3,     DV_DOT ,  _______,  /*  */ _______,  KC_MINS,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    _______,
      _______,  KC_0,     KC_4,     KC_5,     KC_6,     DV_COMM,  KC_GRV,   /*  */ DV_SLSH,  KC_EQL,   KC_F5,    KC_F6,    KC_F7 ,   KC_F8,    _______,
      _______,  DV_RBRC,  KC_7,     KC_8,     KC_9,     DV_MINS,  S(KC_GRV),/*  */ S(DV_SLSH),_______, KC_F9,    KC_F10,   KC_F11,   KC_F12,   _______,
    ...
    [3] = LAYOUT_split_3x7_4(                                                      /* Left-hander QWERTY for gaming */
      ...
      _______,  _______,  _______,  _______,  _______,  _______,  _______,  /*  */ KC_CAPS,  DV_H,     DV_A   ,  DV_S   ,  DV_D   ,  DV_F   ,  DV_G   ,
      _______,  _______,  _______,  _______,  _______,  _______,  _______,  /*  */ KC_LSFT,  DV_M,     DV_Z   ,  DV_X   ,  DV_C   ,  DV_V   ,  DV_B   ,
                                    XXXXXXX,  _______,  _______,  TG(3),    /*  */ KC_LCTL,  LT(4, KC_SPC),KC_LALT,KC_ESC),
   [4] = LAYOUT_split_3x7_4(
     _______,  _______,  _______,  _______,  _______,  _______,  _______,  /*  */ _______,  _______,  KC_1,     KC_2,     KC_3,      DV_EQL,   _______,
